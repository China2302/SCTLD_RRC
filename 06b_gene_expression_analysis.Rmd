---
title: "06a_gene_expression_analysis- 4M mapped reads"
...
if (file.exists("cache/dds7e.rds")) {
  ...
  dds7e<- DESeq(dds7e, parallel = TRUE)
...
```
We will use contrast to compare our different groups of suceptibility 
...
###5: result we will compare "SCTLD_affected_High" vs "SCTLD_unaffected_High"
```{r}
