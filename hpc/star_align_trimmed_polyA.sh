#!/bin/bash
#BSUB -J star_align_polyA
#BSUB -q bigmem
#BSUB -P c_transcriptomics
#BSUB -n 16
#BSUB -W 120:00
#BSUB -R "rusage[mem=15000]"
#BSUB -o star_align_polyA%J.out
#BSUB -e star_align_polyA%J.err
...
cd "/nethome/nxa945/forStar_polyA"
...
--outFileNamePrefix ${todata}/NOVA_SCTLD/data/alligned_polyA/${sample} ; \

done

multiqc ${todata}/NOVA_SCTLD/data/alligned_polyA/ \
--outdir ${todata}/NOVA_SCTLD/data/alligned_polyA/
